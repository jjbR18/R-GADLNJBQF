...
Window_ResidentStatus.prototype.initialize = function(x, y, width, height) {
    ...
    Window_Base.prototype.initialize.call(this, 0, 0, 205, yy);
    this.refresh();
};
...
Window_ResidentStatus.prototype.refresh = function(){
    ...
    if(RSW_GaugeFrameON === true){
        this.drawActorHp(this.party_leader, 5+plusPos, 5+plusPos, 200);
        this.drawPicture('GaugeFrame', plusPos, plusPos);
        this.drawActorMp(this.party_leader, 5+plusPos, 28+RSW_paddingHeight+5+plusPos, 200);
        this.drawPicture('GaugeFrame', plusPos, 28+RSW_paddingHeight+plusPos);
        if(RSW_TPGaugeON){
            this.drawActorTp(this.party_leader, 5+plusPos, (28+RSW_paddingHeight)*2+5+plusPos, 200);
            this.drawPicture('GaugeFrame', plusPos, (14+RSW_paddingHeight)*2+plusPos);
        }
    }
    else{
        this.drawActorHp(this.party_leader, plusPos, plusPos, 93);
        //this.drawActorMp(this.party_leader, plusPos, 28+RSW_paddingHeight+plusPos, 93);
        if(RSW_TPGaugeON){
            this.drawActorTp(this.party_leader, plusPos, (28+RSW_paddingHeight)*2+plusPos, 93);
        }
    }
};
...
Window_ResidentStatus.prototype.contentsHeight = function() {
    ...
    if(RSW_GaugeFrameON){
        if(RSW_TPGaugeON){
            return (28*3 + RSW_paddingHeight*1 + plusPos);
        }
        else{
